...
opt.train_anno = os.path.join(opt.root_dir, 'NLGtrain.txt')
opt.valid_anno = os.path.join(opt.root_dir, 'NLGtest.txt')
opt.test_anno = os.path.join(opt.root_dir, 'NLGtest.txt')
