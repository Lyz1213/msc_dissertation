...
def model_opts(parser):
    ...
    #Transformer Options
    parser.add_argument('-encoder_embed_dim', type=int, default=200,
                        help='encoder embedding size.')
    parser.add_argument('-decoder_embed_dim', type=int, default=200,
    ...
    parser.add_argument('-decoder_ffn_embed_dim', type=int, default=512,
    ...
    parser.add_argument('-decoder_attention_heads', type=int, default=2,
